...
export declare type RouterChangeByServerResponse = (previousTree: FlightRouterState, flightData: FlightData, overrideCanonicalUrl: URL | undefined) => void;
export declare type RouterNavigate = (href: string, navigateType: 'push' | 'replace', forceOptimisticNavigation: boolean) => void;
...
export declare type ServerActionDispatcher = (args: Omit<ServerActionAction, 'type' | 'mutable' | 'navigate' | 'changeByServerResponse'>) => void;
...
export declare type PrefetchCacheEntry = {
...
export declare type ReadonlyReducerState = Readonly<AppRouterState>;
export declare type ReducerState = AppRouterState;
export declare type ReducerActions = Readonly<RefreshAction | NavigateAction | RestoreAction | ServerPatchAction | PrefetchAction | FastRefreshAction | ServerActionAction>;
export {};
