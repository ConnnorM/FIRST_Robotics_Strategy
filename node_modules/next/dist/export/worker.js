...
async function exportPage({ parentSpanId , path , pathMap , distDir , outDir , pagesDataDir , renderOpts , buildExport , serverRuntimeConfig , subFolders , optimizeFonts , optimizeCss , disableOptimizedLoading , httpAgentOptions , serverComponents , debugOutput , isrMemoryCacheSize , fetchCache , fetchCacheKeyPrefix , incrementalCacheHandlerPath  }) {
    ...
    return exportPageSpan.traceAsyncFn(async ()=>{
            ...
            if (isAppDir) {
                ...
                if (isRouteHandler) {
                    ...
                    try {
                        ...
                        const module = _routemoduleloader.RouteModuleLoader.load(filename);
                        ...
                        if (isValidStatus) {
                            ...
                            const headers = (0, _utils.toNodeHeaders)(response.headers);
         ...
         */ if (optimizeFonts) {
            ...
            const renderResultMeta = (renderResult == null ? void 0 : renderResult.metadata()) || (ampRenderResult == null ? void 0 : ampRenderResult.metadata()) || {};
            if (renderResultMeta.pageData) {
                ...
                await _fs.promises.writeFile(dataFile, JSON.stringify(renderResultMeta.pageData), "utf8");
                if (hybridAmp) {
                    await _fs.promises.writeFile(dataFile.replace(/\.json$/, ".amp.json"), JSON.stringify(renderResultMeta.pageData), "utf8");
                }
            }
