...
const _hotreloader = /*#__PURE__*/ _interop_require_default(require("./hot-reloader"));
...
const _nexttypesplugin = require("../../build/webpack/plugins/next-types-plugin");
    ...
    async startWatcher() {
        ...
        return new Promise(async (resolve, reject)=>{
            ...
            wp.on("aggregated", async ()=>{
                ...
                _nexttypesplugin.devPageFiles.clear();
                for (const [fileName, meta] of knownFiles){
                    ...
                    _nexttypesplugin.devPageFiles.add(fileName);
           ...
           */ if (/[\\\\/]_middleware$/.test(pageName)) {
                ...
                if (numConflicting > 0) {
                    _log.error(`Conflicting app and page file${numConflicting === 1 ? " was" : "s were"} found, please remove the conflicting files to continue:`);
                ...
                this.customRoutes.rewrites.beforeFiles.unshift(...(0, _generateinterceptionroutesrewrites.generateInterceptionRoutesRewrites)(Object.keys(appPaths)));
