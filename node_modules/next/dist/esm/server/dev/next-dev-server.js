...
export default class DevServer extends Server {
    ...
    async startWatcher() {
        ...
        const validFileMatcher = createValidFileMatcher(this.nextConfig.pageExtensions, this.appDir);
        let resolved = false;
        return new Promise(async (resolve, reject)=>{
           ...
           */ if (/[\\\\/]_middleware$/.test(pageName)) {
                ...
                if (this.nextConfig.experimental.clientRouterFilter) {
                    clientRouterFilters = createClientRouterFilter(Object.keys(appPaths), this.nextConfig.experimental.clientRouterFilterRedirects ? (this.nextConfig._originalRedirects || []).filter((r)=>!r.internal) : [], this.nextConfig.experimental.clientRouterFilterAllowedRate);
                ...
                if (envChange || tsconfigChange) {
                    var _this_hotReloader, _this_hotReloader_activeConfigs, _this_hotReloader1;
                    if (envChange) {
                        this.loadEnvConfig({
                            dev: true,
                            forceReload: true,
                    ...
                    (_this_hotReloader = this.hotReloader) == null ? void 0 : (_this_hotReloader_activeConfigs = _this_hotReloader.activeConfigs) == null ? void 0 : _this_hotReloader_activeConfigs.forEach((config, idx)=>{
                    ...
                    (_this_hotReloader1 = this.hotReloader) == null ? void 0 : _this_hotReloader1.invalidate();
                }
                ...
                this.customRoutes.rewrites.beforeFiles.unshift(...generateInterceptionRoutesRewrites(Object.keys(appPaths)));
                ...
                try {
                    ...
                    if (!((_this_sortedRoutes = this.sortedRoutes) == null ? void 0 : _this_sortedRoutes.every((val, idx)=>val === sortedRoutes[idx]))) {
                        ...
                        _this_hotReloader2;
                        (_this_hotReloader2 = this.hotReloader) == null ? void 0 : _this_hotReloader2.send(undefined, {
    ...
    async invokeIpcMethod(method, args) {
        ...
        if (ipcPort) {
            const res = await invokeRequest(`http://${this.hostname}:${ipcPort}?key=${ipcKey}&method=${method}&args=${encodeURIComponent(JSON.stringify(args))}`, {
                method: "GET",
                headers: {}
            });
            const chunks = [];
        ...
        if (isError(err) && err.stack) {
            try {
                ...
                if ((frame == null ? void 0 : frame.lineNumber) && (frame == null ? void 0 : frame.file)) {
                    ...
                    const source = await getSourceById(!!((_frame_file = frame.file) == null ? void 0 : _frame_file.startsWith(sep)) || !!((_frame_file1 = frame.file) == null ? void 0 : _frame_file1.startsWith("file:")), moduleId, compilation);
