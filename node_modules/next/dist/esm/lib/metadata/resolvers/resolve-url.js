...
export function getSocialImageFallbackMetadataBase(metadataBase) {
    ...
    if (isMetadataBaseMissing) {
        ...
        console.log();
        Log.warnOnce(`metadata.metadataBase is not set for resolving social open graph or twitter images, fallbacks to "${fallbackMetadata.origin}". See https://beta.nextjs.org/docs/api-reference/metadata#metadatabase`);
    }
